...
findStock() {
  fetch('https://stark-taiga-05033.herokuapp.com/' + this.state.userQuery, {
    method: 'GET',
    headers: {
...
handleUserPurchase = () => {
  fetch('https://stark-taiga-05033.herokuapp.com/', {
    method: 'post',
...
updateUserAccountInfo = () => {
  fetch('https://stark-taiga-05033.herokuapp.com/' + this.state.user.id, {
    method: 'get',
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json'
