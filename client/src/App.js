...
findStock() {
  fetch('https://luna-stock-trader.herokuapp.com/search/' + this.state.userQuery, {
    method: 'GET',
    headers: {
...
handleUserPurchase = () => {
  fetch('https://luna-stock-trader.herokuapp.com/transactions', {
    method: 'post',
...
updateUserAccountInfo = () => {
  fetch('https://luna-stock-trader.herokuapp.com/profile/' + this.state.user.id, {
    method: 'get',
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
findUserTransactions = () => {
  fetch('https://luna-stock-trader.herokuapp.com/transactions/' + this.state.user.id, {
    method: 'get',
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
findUserPortfolio = () => {
  fetch('https://luna-stock-trader.herokuapp.com/portfolio/' + this.state.user.id, {
    method: 'get',
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json'
